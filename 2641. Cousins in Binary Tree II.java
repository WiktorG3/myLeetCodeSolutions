    ...
    public TreeNode replaceValueInTree(TreeNode root) {
        ...
        while (!queue.isEmpty()) {
            ...
            for(TreeNode node : currentLevelNodes){
                ...
                if(node.left != null && node.right != null) siblingSum = node.left.val + node.right.val;
                else if(node.left != null) siblingSum = node.left.val;
                else if(node.right != null) siblingSum = node.right.val;
